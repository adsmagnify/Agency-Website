        ...
        {words.map((word, wordIndex) => {
          ...
          if (isAccent) {
            return (
              <span
                key={wordIndex}
                className="relative inline-block mx-1.5 px-2 py-0.5 overflow-visible align-baseline"
                style={{ transformStyle: "preserve-3d" }}
              >
                {/* Glowing Accent Letters */}
                <span className="hero-accent-text italic font-normal text-[#004AAD] inline-block pr-3 overflow-visible relative z-10 drop-shadow-[0_2px_12px_rgba(0,74,173,0.18)]">
                ...
                <span className="magnify-underline pointer-events-none absolute -bottom-0.5 left-1 right-3 h-[2.5px] bg-gradient-to-r from-[#004AAD] via-[#4CA3FF] to-[#FFC619] rounded-full" />
              </span>
            );
          }
